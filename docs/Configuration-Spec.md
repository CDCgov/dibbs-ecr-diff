...
The matching rule's `id` and `displayName` are included in the [Diff Output Spec](./Diff-Output-Spec.md) as `actionabilityRuleId` and `actionabilityRuleDisplayName`.
